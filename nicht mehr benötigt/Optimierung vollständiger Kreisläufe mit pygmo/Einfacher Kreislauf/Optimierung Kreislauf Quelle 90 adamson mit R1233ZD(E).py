...
class HeatPumpCycle:
    ...
    def __init__(self):
        ...
        h_uebe = CPSI("H", "P", 5.1 * 1e5, "T", 273.15 + 75, wf) * 1e-3
...
bounds = [0.69, 0.7, 0.71, 0.715, 0.72, 0.725, 0.73, 0.74, 0.745, 0.75, 0.755]
