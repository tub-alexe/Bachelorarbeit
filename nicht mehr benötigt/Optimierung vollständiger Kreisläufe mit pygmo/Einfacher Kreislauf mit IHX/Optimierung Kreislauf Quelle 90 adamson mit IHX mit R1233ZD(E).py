...
class HeatPumpCycle:
    ...
    def __init__(self):
        ...
        h_ihx_h_nach = CPSI("H", "P", 5.1 * 1e5, "T", 273.15 + 100, wf) * 1e-3
...
variables = {
    "Connections": {
        "3": {"p": {"min": 34, "max": 58}, "T": {"min": 100, "max": 110}},
        "1": {"p": {"min": 3.6, "max": 6}}
    }
}
constraints = {
...
bounds = [0.69, 0.7, 0.71, 0.72, 0.73, 0.74, 0.745, 0.75, 0.755, 0.76, 0.765]
...
cbar.set_label("eta")
plt.show()
fig.savefig('pygmo_optimization_IHX_R1233ZD(E).svg')