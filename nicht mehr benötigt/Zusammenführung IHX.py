...
with open('../Simulation/Vollständige Kreisläufe/mit interner Wärmerückgewinnung/IWR.txt') as f:
    read = f.readlines()
...
plt.grid()
plt.show()
plt.savefig('Zusammenführung_IHX_COP.svg')
...
plt.grid()
plt.show()
plt.savefig('Zusammenführung_IHX_eta.svg')