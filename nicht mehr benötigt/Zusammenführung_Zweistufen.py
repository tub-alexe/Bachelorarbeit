...
with open('../Simulation/Vollständige Kreisläufe/Zweistufenkompression mit Zwischenkühlung/Zweistufenkompression.txt') as f:
    read = f.readlines()
...
plt.show()
plt.savefig('Zusammenführung_Zweistufen_COP.svg')
...
plt.legend(loc='upper right')
plt.show()
plt.savefig('Zusammenführung_Zweistufen_eta.svg')