...
anfang = Source('Kreislauf ein')
ende = Sink('Kreislauf aus')
...
h_zw = CPSI("H", "Q", 1, "T", 273.15+70.05, km) * 1e-3
c4.set_attr(h=h_zw)

# Nach dem Überhitzer
h_uebe = CPSI("H", "P", 6.1 * 1e5, "T", 273.15+75, km) * 1e-3
