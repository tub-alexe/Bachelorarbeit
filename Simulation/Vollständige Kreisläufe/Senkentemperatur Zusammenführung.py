...
#plt.plot(data_IHX_T120_R1233ZDE, eta_IHX_T120_R1233ZDE, marker='o',  color='blueviolet', label='120°C IHX')
#plt.plot(38.37, 75.84, color='black', marker='x', markersize=9)
...
plt.ylabel('exergetischer Wirkungsgrad')
#plt.legend(loc='upper right', fontsize='13')
plt.legend(handles=[o_line, s_line, red_line, yellow_line, green_line, blue_line], loc='upper right', fontsize='16')
plt.grid()
plt.show()
