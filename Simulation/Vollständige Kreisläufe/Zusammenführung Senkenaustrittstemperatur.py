...
data_ttd_u_40_IHX_R1233ZDE = json.loads(read[57])
eta_ttd_u_40_IHX_R1233ZDE = json.loads(read[58])

data_ttd_u_30_IHX_R1233ZDE = json.loads(read[60])
eta_ttd_u_30_IHX_R1233ZDE = json.loads(read[61])

data_ttd_u_20_IHX_R1233ZDE = json.loads(read[63])
eta_ttd_u_20_IHX_R1233ZDE = json.loads(read[64])

data_ttd_u_15_IHX_R1233ZDE = json.loads(read[66])
eta_ttd_u_15_IHX_R1233ZDE = json.loads(read[67])
...
data_ttd_u_3_Parallel_R1233ZDE = json.loads(read[57])
eta_ttd_u_3_Parallel_R1233ZDE = json.loads(read[58])

data_ttd_u_5_Parallel_R1233ZDE = json.loads(read[60])
eta_ttd_u_5_Parallel_R1233ZDE = json.loads(read[61])

data_ttd_u_7_Parallel_R1233ZDE = json.loads(read[63])
eta_ttd_u_7_Parallel_R1233ZDE = json.loads(read[64])

data_ttd_u_10_Parallel_R1233ZDE = json.loads(read[66])
eta_ttd_u_10_Parallel_R1233ZDE = json.loads(read[67])

data_ttd_u_15_Parallel_R1233ZDE = json.loads(read[69])
eta_ttd_u_15_Parallel_R1233ZDE = json.loads(read[70])
...
o_line = mlines.Line2D([], [], color='black', label='T_se,ein [°C]        ttd_gk,ob:')
s_line = mlines.Line2D([], [], color='black',  linestyle='--', label='ttd_gk,ob:')
red_line = mlines.Line2D([], [], color='steelblue', linestyle='--', label='40 K')
yellow_line = mlines.Line2D([], [], color='green', linestyle='--', label='30 K')
green_line = mlines.Line2D([], [], color='orange', linestyle='--', label='20 K')
blue_line = mlines.Line2D([], [], color='red', linestyle='--', label='15 K')
plt.ylim(59, 72.5)
plt.xlim(37.5, 59)
...
plt.annotate('190', xy=(37.9, 68.65), xytext=(37.9, 68.65))
...
plt.annotate('195', xy=(38.52, 72.67), xytext=(38.52, 72.67))
...
plt.annotate('200', xy=(40.6, 73.55), xytext=(40.6, 73.55))
...
plt.annotate('205', xy=(43.55, 73.66), xytext=(43.55, 73.66))
...
plt.annotate('210', xy=(46.59, 73.65), xytext=(46.79, 73.65))
...
plt.annotate('215', xy=(50.45, 73.5), xytext=(50.45, 73.5))
...
plt.annotate('220', xy=(54.4, 73.4), xytext=(54.4, 73.4))
#plt.plot(59.53, 72.56, color='black', marker='x', markersize=12)
plt.plot(data_ttd_u_3_Parallel_R1233ZDE, eta_ttd_u_3_Parallel_R1233ZDE, linestyle='--', color='red', label='3 K')
plt.plot(data_ttd_u_5_Parallel_R1233ZDE, eta_ttd_u_5_Parallel_R1233ZDE, linestyle='--', color='orange', label='5 K')
plt.plot(data_ttd_u_7_Parallel_R1233ZDE, eta_ttd_u_7_Parallel_R1233ZDE, linestyle='--', color='green', label='7 K')
plt.plot(data_ttd_u_10_Parallel_R1233ZDE, eta_ttd_u_10_Parallel_R1233ZDE, linestyle='--', color='steelblue', label='10 K')
plt.plot(data_ttd_u_15_Parallel_R1233ZDE, eta_ttd_u_15_Parallel_R1233ZDE, linestyle='--', color='blueviolet', label='15 K')
plt.xlabel('Gaskühlerdruck [bar]')
plt.ylabel('exergetischer Wirkungsgrad [%]')
