...
p_zw = 13
c1_co.set_attr(p=p_zw)
h_c2 = CPSI("H", "P", p_zw * 1e5, "T", 273.15+145, wf) * 1e-3
c2.set_attr(h=h_c2)


h_ihx_k_vor = CPSI("H", "P", 37 * 1e5, "T", 273.15+105, wf) * 1e-3
c4.set_attr(h=h_ihx_k_vor, p=37)

h_zw = CPSI("H", "P", 2.8*1e5, "Q", 1, wf) * 1e-3
c6_ue.set_attr(h=h_zw)

h_ihx_k_nach = CPSI("H", "P", 2.8 * 1e5, "T", 273.15+75, wf) * 1e-3
c7.set_attr(h=h_ihx_k_nach)

c8.set_attr(T=100, p=20, fluid={'Pentane': 0, 'H2O': 1})
c9.set_attr(T=200)

# Starting Parameters Connection Source
c10.set_attr(T=80, m=5, p=5, fluid={'Pentane': 0, 'H2O': 1})
c12.set_attr(T=75)
c13.set_attr(T=100, m=10, p=10, fluid={'Pentane': 0, 'H2O': 1})
