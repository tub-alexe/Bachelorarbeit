...
h_c22 = CPSI("H", "P", 93 * 1e5, "T", 273.15+165, wf) * 1e-3
c22.set_attr(h=h_c22, p=93)

c23.set_attr(p=12.492)

h_c24 = CPSI("H", "P", 12.492 * 1e5, "T", 273.15+90.1, wf) * 1e-3
c24.set_attr(h=h_c24, fluid={'Butane': 1, 'H2O': 0})
