...
h_gk_nach = CPSI("H", "P", 56 * 1e5, "T", 273.15+165, wf) * 1e-3
c2.set_attr(h=h_gk_nach, p=56)

c3.set_attr(p=5.1)

h_c4 = CPSI("H", "P", 5.1 * 1e5, "T", 273.15+90.1, wf) * 1e-3
...
data = {
    'p_kond': np.linspace(52, 96, iterations)
}
