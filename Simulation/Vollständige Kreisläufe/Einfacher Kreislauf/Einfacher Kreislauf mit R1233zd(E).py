...
h_gk_nach = CPSI("H", "P", 57 * 1e5, "T", 273.15+165, wf) * 1e-3
c2.set_attr(h=h_gk_nach, p=57)

c3.set_attr(p=8.334)

h_c4 = CPSI("H", "P", 8.334 * 1e5, "T", 273.15+90.1, wf) * 1e-3
...
c8.set_attr(T=95, p=5, fluid={'R1233ZD(E)': 0, 'H2O': 1})
c9.set_attr(T=90)
...
data = {
    'p_kond': np.linspace(48, 91, iterations)
}
