...
class HeatPumpCycle:
    ...
    def __init__(self):
        ...
        c1.set_attr(h=h_ihx_h_nach, p=2.8, fluid={'R1336mzz(Z)': 1, 'H2O': 0})

        h_ihx_k_vor = CPSI("H", "P", 41 * 1e5, "T", 273.15 + 105, wf) * 1e-3
        c3.set_attr(h=h_ihx_k_vor, p=41)
...
variables = {
    "Connections": {
        "3": {"p": {"min": 41, "max": 54}, "T": {"min": 100, "max": 110}},
        "1": {"p": {"min": 2, "max": 3.8}},
    }
}
constraints = {
